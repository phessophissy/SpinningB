# Game replay viewer component — Part 3

## Overview

This document covers component 3 of the Game replay viewer component feature.
...
```javascript
import { init3 } from './feature-replay-viewer-3';
