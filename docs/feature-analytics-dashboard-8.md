# Analytics dashboard with charts — Part 8

## Overview

This document covers component 8 of the Analytics dashboard with charts feature.
...
```javascript
import { init8 } from './feature-analytics-dashboard-8';
