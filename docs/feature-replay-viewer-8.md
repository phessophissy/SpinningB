# Game replay viewer component — Part 8

## Overview

This document covers component 8 of the Game replay viewer component feature.
...
```javascript
import { init8 } from './feature-replay-viewer-8';
