# Spin history export functionality — Part 8

## Overview

This document covers component 8 of the Spin history export functionality feature.
...
```javascript
import { init8 } from './feature-spin-history-export-8';
