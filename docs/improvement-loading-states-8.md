# Add loading states and skeleton screens — Part 8

## Overview

This document covers component 8 of the Add loading states and skeleton screens feature.
...
```javascript
import { init8 } from './improvement-loading-states-8';
