# Game statistics dashboard — Part 13

## Overview

This document covers component 13 of the Game statistics dashboard feature.
...
```javascript
import { init13 } from './feature-game-statistics-13';
