# Custom board skins and themes — Part 8

## Overview

This document covers component 8 of the Custom board skins and themes feature.
...
```javascript
import { init8 } from './feature-custom-board-skins-8';
