# Dark mode toggle for frontend — Part 13

## Overview

This document covers component 13 of the Dark mode toggle for frontend feature.
...
```javascript
import { init13 } from './feature-dark-mode-toggle-13';
