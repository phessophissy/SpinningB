# Live STX price ticker widget — Part 3

## Overview

This document covers component 3 of the Live STX price ticker widget feature.
...
```javascript
import { init3 } from './feature-stx-price-ticker-3';
