# Friend challenge and invite system — Part 8

## Overview

This document covers component 8 of the Friend challenge and invite system feature.
...
```javascript
import { init8 } from './feature-friend-challenges-8';
