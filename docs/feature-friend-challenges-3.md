# Friend challenge and invite system — Part 3

## Overview

This document covers component 3 of the Friend challenge and invite system feature.
...
```javascript
import { init3 } from './feature-friend-challenges-3';
