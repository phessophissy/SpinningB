# Staking rewards for loyal players — Part 3

## Overview

This document covers component 3 of the Staking rewards for loyal players feature.
...
```javascript
import { init3 } from './feature-staking-rewards-3';
