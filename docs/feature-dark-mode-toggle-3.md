# Dark mode toggle for frontend — Part 3

## Overview

This document covers component 3 of the Dark mode toggle for frontend feature.
...
```javascript
import { init3 } from './feature-dark-mode-toggle-3';
