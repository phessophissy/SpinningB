# User onboarding guide and FAQ — Part 8

## Overview

This document covers component 8 of the User onboarding guide and FAQ feature.
...
```javascript
import { init8 } from './docs-user-onboarding-guide-8';
