# VRF-based on-chain randomness — Part 3

## Overview

This document covers component 3 of the VRF-based on-chain randomness feature.
...
```javascript
import { init3 } from './feature-vrf-randomness-3';
