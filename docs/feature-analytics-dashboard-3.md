# Analytics dashboard with charts — Part 3

## Overview

This document covers component 3 of the Analytics dashboard with charts feature.
...
```javascript
import { init3 } from './feature-analytics-dashboard-3';
