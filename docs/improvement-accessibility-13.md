# Accessibility improvements (ARIA, focus) — Part 13

## Overview

This document covers component 13 of the Accessibility improvements (ARIA, focus) feature.
...
```javascript
import { init13 } from './improvement-accessibility-13';
