# Auto-spin scheduler with limits — Part 3

## Overview

This document covers component 3 of the Auto-spin scheduler with limits feature.
...
```javascript
import { init3 } from './feature-auto-spin-scheduler-3';
