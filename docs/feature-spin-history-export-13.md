# Spin history export functionality — Part 13

## Overview

This document covers component 13 of the Spin history export functionality feature.
...
```javascript
import { init13 } from './feature-spin-history-export-13';
