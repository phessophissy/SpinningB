# VRF-based on-chain randomness — Part 8

## Overview

This document covers component 8 of the VRF-based on-chain randomness feature.
...
```javascript
import { init8 } from './feature-vrf-randomness-8';
