# NFT-based spin ticket system — Part 8

## Overview

This document covers component 8 of the NFT-based spin ticket system feature.
...
```javascript
import { init8 } from './feature-nft-spin-tickets-8';
