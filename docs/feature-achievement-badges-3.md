# Achievement badges and rewards system — Part 3

## Overview

This document covers component 3 of the Achievement badges and rewards system feature.
...
```javascript
import { init3 } from './feature-achievement-badges-3';
