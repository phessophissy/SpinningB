# Auto-spin scheduler with limits — Part 8

## Overview

This document covers component 8 of the Auto-spin scheduler with limits feature.
...
```javascript
import { init8 } from './feature-auto-spin-scheduler-8';
