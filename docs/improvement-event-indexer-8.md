# Event indexer for game history — Part 8

## Overview

This document covers component 8 of the Event indexer for game history feature.
...
```javascript
import { init8 } from './improvement-event-indexer-8';
