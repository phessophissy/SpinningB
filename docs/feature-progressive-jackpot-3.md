# Progressive jackpot accumulator — Part 3

## Overview

This document covers component 3 of the Progressive jackpot accumulator feature.
...
```javascript
import { init3 } from './feature-progressive-jackpot-3';
