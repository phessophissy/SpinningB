# Wallet analytics and balance tracking — Part 8

## Overview

This document covers component 8 of the Wallet analytics and balance tracking feature.
...
```javascript
import { init8 } from './feature-wallet-analytics-8';
