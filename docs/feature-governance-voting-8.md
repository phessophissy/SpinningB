# Governance voting for game params — Part 8

## Overview

This document covers component 8 of the Governance voting for game params feature.
...
```javascript
import { init8 } from './feature-governance-voting-8';
