# Contributor handbook and guidelines — Part 3

## Overview

This document covers component 3 of the Contributor handbook and guidelines feature.
...
```javascript
import { init3 } from './docs-contributor-handbook-3';
