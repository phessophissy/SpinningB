...
## Purpose
Define a repeatable process for Postmortem Template in the SpinningB repository.
...
## Procedure
1. Review contract expectations in contracts/spinning-board.clar related to Postmortem Template.
...
- [ ] Contract behavior for Postmortem Template is documented and verified.
