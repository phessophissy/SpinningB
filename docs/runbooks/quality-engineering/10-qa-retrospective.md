...
## Purpose
Define a repeatable process for Qa Retrospective in the SpinningB repository.
...
## Procedure
1. Review contract expectations in contracts/spinning-board.clar related to Qa Retrospective.
...
- [ ] Contract behavior for Qa Retrospective is documented and verified.
