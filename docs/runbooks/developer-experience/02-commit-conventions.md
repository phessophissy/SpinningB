...
## Purpose
Define a repeatable process for Commit Conventions in the SpinningB repository.
...
## Procedure
1. Review contract expectations in contracts/spinning-board.clar related to Commit Conventions.
...
- [ ] Contract behavior for Commit Conventions is documented and verified.
