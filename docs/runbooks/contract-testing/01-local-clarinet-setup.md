# Local Clarinet Setup

## Purpose
Define a repeatable process for Local Clarinet Setup in the SpinningB repository.
...
## Procedure
1. Review contract expectations in contracts/spinning-board.clar related to Local Clarinet Setup.
...
- [ ] Contract behavior for Local Clarinet Setup is documented and verified.
