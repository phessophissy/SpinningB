# NFT-based spin ticket system — Part 3

## Overview

This document covers component 3 of the NFT-based spin ticket system feature.
...
```javascript
import { init3 } from './feature-nft-spin-tickets-3';
