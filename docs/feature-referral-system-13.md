# Referral system with tracking codes — Part 13

## Overview

This document covers component 13 of the Referral system with tracking codes feature.
...
```javascript
import { init13 } from './feature-referral-system-13';
