# Gas optimization for transactions — Part 3

## Overview

This document covers component 3 of the Gas optimization for transactions feature.
...
```javascript
import { init3 } from './improvement-gas-optimization-3';
