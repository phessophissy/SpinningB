# Accessibility improvements (ARIA, focus) — Part 8

## Overview

This document covers component 8 of the Accessibility improvements (ARIA, focus) feature.
...
```javascript
import { init8 } from './improvement-accessibility-8';
