# Social sharing integration — Part 13

## Overview

This document covers component 13 of the Social sharing integration feature.
...
```javascript
import { init13 } from './feature-social-sharing-13';
