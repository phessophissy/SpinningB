# In-app notification system — Part 8

## Overview

This document covers component 8 of the In-app notification system feature.
...
```javascript
import { init8 } from './feature-notification-system-8';
