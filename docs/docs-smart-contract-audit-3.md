# Smart contract audit documentation — Part 3

## Overview

This document covers component 3 of the Smart contract audit documentation feature.
...
```javascript
import { init3 } from './docs-smart-contract-audit-3';
