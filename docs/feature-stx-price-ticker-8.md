# Live STX price ticker widget — Part 8

## Overview

This document covers component 8 of the Live STX price ticker widget feature.
...
```javascript
import { init8 } from './feature-stx-price-ticker-8';
