...
const importActivityInput = document.getElementById('importActivityInput');
...
const applyOracleBtn = document.getElementById('applyOracleBtn');
const playStreak = document.getElementById('playStreak');
const lastSpin = document.getElementById('lastSpin');
const peakSpin = document.getElementById('peakSpin');
const localPlays = document.getElementById('localPlays');
